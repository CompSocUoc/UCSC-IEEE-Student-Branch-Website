...
### User Profile by http://pickplugins.com

* [Live Demo!&raquo;](http://www.pickplugins.com/demo/user-profile/author/manovotny/)
* [Support!&raquo;](http://pickplugins.com/question/)
...
to see user profile please visit link like bellow on your site.

`http://example.com/author/admin/`


<strong>Post feed</strong>
Display list of post followed authors

`[up_follower_post_feed]`
...
== Changelog ==
    ...
    * 14/08/2016 update - rewite plugin code.

	= 1.5 =
	
    * 21/09/2015 add - total followers count.
    

	= 1.4 =
	
    * 15/09/2015 add - post feed for followers.
